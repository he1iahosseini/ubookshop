export const Block = props => {
    ...
    return <c-c style={{
        ...
        position: "relative", backgroundColor: "white", borderRadius: 5, margin: "10px",
        boxShadow: "0px 0px 5px 2px rgba(0,0,0,0.43)"
    }}>
        ...
        <img
            ...
            style={{
                width: "100%", height: 200, objectFit: "fill", minWidth: 150, borderTopLeftRadius: 5,
        ...
        <f-cc style={{ padding: "5px 8px", width: "100%", height: 40, direction: "ltr" }}>
            <f-12>{props.book.title}</f-12>
        </f-cc>
        <f-csb style={{ width: "100%", padding: "5px 0" }}>
            <img src={props.state.cart.includes(props.book.title)?
            "https://irmapserver.ir/research/37/check.png":
            "https://irmapserver.ir/research/37/shopping-cart.png"}
                style={{ height: 30, width: 30, objectFit: "contain", margin: "5px 5px" }} />
